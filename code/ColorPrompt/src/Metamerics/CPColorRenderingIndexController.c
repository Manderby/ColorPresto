...
struct CPColorRenderingIndexController{
  NASpace* space;

  NALabel* title;
  NALabel* color1IndexLabel;
  NALabel* color1Label;
  CPTwoColorController* color1Display;
  NALabel* color2IndexLabel;
  NALabel* color2Label;
  CPTwoColorController* color2Display;
  NALabel* color3IndexLabel;
  NALabel* color3Label;
  CPTwoColorController* color3Display;
  NALabel* color4IndexLabel;
  NALabel* color4Label;
  CPTwoColorController* color4Display;
  NALabel* color5IndexLabel;
  NALabel* color5Label;
  CPTwoColorController* color5Display;
  NALabel* color6IndexLabel;
  NALabel* color6Label;
  CPTwoColorController* color6Display;
  NALabel* color7IndexLabel;
  NALabel* color7Label;
  CPTwoColorController* color7Display;
  NALabel* color8IndexLabel;
  NALabel* color8Label;
  CPTwoColorController* color8Display;
...
//  naSetSpaceAlternateBackground(con->space, NA_TRUE);
  ...
  con->title = cpNewTitleLabel(cpTranslate(CPColorRenderingIndex), 200);
