...
// General things.
NA_LOC(CPApplicationName, "Color Machine");  // do not translate
...
// Observer Strings
NA_LOC(CPObserverTitle, "Beobachter");
NA_LOC(CPObserverSteps, "Schrittweite");
...
NA_LOC(CPIlluminationTitle, "Beleuchtung");
NA_LOC(CPIlluminationTemperature, "Temperatur");
NA_LOC(CPIlluminationKelvin, "K");         // do not translate
NA_LOC(CPIlluminationWhitePoint, "Weisspunkt Yxy");

// RGB Colorspace Strings
NA_LOC(CPRGBColorSpaceTitle, "RGB Farbraum");
NA_LOC(CPRGBColorSpaceRed, "Rot");
NA_LOC(CPRGBColorSpaceGreen, "Grün");
NA_LOC(CPRGBColorSpaceBlue, "Blau");
NA_LOC(CPRGBColorResponse, "Helligkeitskurve");
...
NA_LOC(CPLabColorSpaceTitle, "Lab Farbraum");
NA_LOC(CPLabColorSpaceK, "K");    // do not translate
NA_LOC(CPLabColorSpaceke, "ke");  // do not translate

// Gray Colorspace Strings
NA_LOC(CPGrayColorSpace, "Grau Farbraum");
NA_LOC(CPGrayDisplayColor, "Farbe");
NA_LOC(CPGrayDisplayGray, "Grau");
...
NA_LOC(CPColorSpace, "Farbraum");     // DO translate
...
NA_LOC(CPWhitePointsAndMetamerics, "Weisspunkte und Metamerie");
// %s is the name of the currently selected illumination.
NA_LOC(CPCurrentIllumination, "Ausgewählt: %s");
NA_LOC(CPReferenceIllumination, "Referenz:");
NA_LOC(CPChromaticityErrorTitle, "Chromatischer Fehler:");
NA_LOC(CPColorRenderingIndex, "Farbwiedergabe-Index:");
NA_LOC(CPVisMetamericIndex, "Metamerie-Index sichtbarer Bereich:");
NA_LOC(CPUVMetamericIndex, "Metamerie-Index UV-Bereich:");
NA_LOC(CPTotalMetamericIndex, "Metamerie-Index Total (1-8):");
// %s is a letter A-E denoting a grade.
NA_LOC(CPGrade, "Güteklasse %s");
NA_LOC(CPD50, "D50");
NA_LOC(CPD55, "D55");
NA_LOC(CPD65, "D65");
NA_LOC(CPD75, "D75");
...
NA_LOC(CP3DView, "3D Ansicht");
NA_LOC(CPCoordinates, "Koordinaten");
NA_LOC(CPSteps, "Unterteilungen");
NA_LOC(CPRotation, "Rotation");
NA_LOC(CPStop, "Stopp");
NA_LOC(CPCartesian, "%s Kartesisch"); // %s is a colorspace name
NA_LOC(CPPointsOpacity, "Punkte Deckkraft");
NA_LOC(CPGridOpacity, "Raster Deckkraft");
NA_LOC(CPGridTint, "Raster Färbung");
NA_LOC(CPBodyTint, "Körper Färbung");
NA_LOC(CPSolid, "Solider Körper");
NA_LOC(CPAxis, "Achsen");
